...
class NGO(models.Model):
    ...
    website = models.CharField(max_length = 100, default="https://www.akshayapatra.org/")
    social = models.CharField(max_length=100, default="https://www.instagram.com/")
...
class Restraunts(models.Model):
    ...
    approx_people = models.IntegerField()
    ngolat = models.FloatField(blank = True, null = True)
    ngolong = models.FloatField(blank = True, null = True)

    def save(self, *args, **kwargs):
        g = geocoder.mapbox(self.r_location, key = access_token)
        g = g.latlng
        self.ngolat = g[0]
        self.ngolong = g[1]
        return super(Restraunts, self).save(*args, **kwargs)